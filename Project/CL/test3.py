...
def main():
    try:
        ...
        # Save Arabic summary to a text file
        output_file_path = r"D:\owd1\Documents\GitHub-REPO\LangChain_documentation_Tutorials\Project\CL\output\arabic_summary.txt"
        save_to_file(arabic_summary, output_file_path)
        print(f"Arabic summary has been saved to: {output_file_path}")
